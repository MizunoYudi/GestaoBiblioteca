...
let CursoController = class CursoController {
    ...
    async exibirCursos(fail, sucess) {
        try {
            const cursos = await this.cursoService.listarCursos();
            return sucess(200, new BasicResponseDto_1.BasicResponseDto("Categorias: ", cursos));
        }
        catch (e) {
            return fail(404, new BasicResponseDto_1.BasicResponseDto(`Erro ao buscar curso: \n${e.message}`, undefined));
        }
    }
};
...
], CursoController.prototype, "exibirCursos", null);
